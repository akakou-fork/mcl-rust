...
extern "C" {
    // global functions
    fn mclBn_init(curve: u32, compiledTimeVar: u32) -> u32;
    ...
    fn mclBnFr_setStr(x: *mut Fr, buf: *const u8, bufSize: usize, ioMode: i32) -> u32;
    ...
    fn mclBnFp_setStr(x: *mut Fp, buf: *const u8, bufSize: usize, ioMode: i32) -> u32;
    ...
    fn mclBnFp2_setStr(x: *mut Fp2, buf: *const u8, bufSize: usize, ioMode: i32) -> u32;
    ...
    fn mclBnG1_setStr(x: *mut G1, buf: *const u8, bufSize: usize, ioMode: i32) -> u32;
    ...
    fn mclBnG1_hashAndMapTo(x: *mut G1, buf: *const u8, bufSize: usize) -> u32;
    ...
    fn mclBnG2_setStr(x: *mut G2, buf: *const u8, bufSize: usize, ioMode: i32) -> u32;
    ...
    fn mclBnG2_hashAndMapTo(x: *mut G2, buf: *const u8, bufSize: usize) -> u32;
    ...
    fn mclBnGT_setStr(x: *mut GT, buf: *const u8, bufSize: usize, ioMode: i32) -> u32;
...
const MCLBN_COMPILED_TIME_VAR: u32 = MCLBN_FR_UNIT_SIZE as u32 * 10 + MCLBN_FP_UNIT_SIZE as u32;
...
pub fn init(curve: CurveType) -> bool {
    unsafe { mclBn_init(curve as u32, MCLBN_COMPILED_TIME_VAR) == 0 }
}
